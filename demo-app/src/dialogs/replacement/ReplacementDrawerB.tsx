...
const ReplacementDrawerB: React.FC<ReplacementDrawerBProps> = ({
  open,
  onClose,
}) => (
  <Drawer open={open} onClose={onClose} title="Replacement B">
    <div className="dialog-content">
      ...
      <p>
        The URL now contains only <code>replacement-b</code>. The previous entry
        was cleanly removed in a single navigation step.
      </p>
